...
export default function Pendientes() {
  const {allpendientes,loadingpendientes} = usePendientes()
  ...
  const pendiente = allpendientes.data
  return (
    <>
            ...
            <table className='p-3 w-full overflow-auto'>
              ...
              <tbody >
                {pendiente?.map(pendiente=>    
                    <tr key={pendiente['id']} className=' text-left w-full  border-b-2 border-slate-200  hover:cursor-pointer text-sm'>
                    <td className='text-center items-center'>{pendiente['nombre']}</td>
                    <td className='text-center items-center'>{pendiente['email']}</td>
                    <td className='text-center items-center'>{pendiente['cedula']}</td>
                    <td className='text-center items-center'>{pendiente['telefono']}</td>
                    <td className='text-center items-center'>{pendiente['nombre_estado']}</td>
                    <td className='text-center items-center'>{pendiente['placa']}</td>
